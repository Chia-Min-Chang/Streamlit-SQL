...
<html class="">
	<head>
		...
		<meta property="og:title" content="app.py · Chia-Min-Chang/SQL at main" />
		<meta property="og:type" content="website" />
		<meta property="og:url" content="https://huggingface.co/spaces/Chia-Min-Chang/SQL/blob/main/app.py" />
		<meta property="og:image" content="https://cdn-thumbnails.huggingface.co/social-thumbnails/spaces/Chia-Min-Chang/SQL.png" />

		<link rel="stylesheet" href="/front/build/style.5b4f05534.css" />
		...
		<title>app.py · Chia-Min-Chang/SQL at main</title>
	</head>
	<body class="flex flex-col min-h-screen bg-white dark:bg-gray-950 text-black ViewerBlobPage">
		<div class="flex min-h-screen flex-col ">
	<div class="SVELTE_HYDRATER contents" data-props="{&quot;avatarUrl&quot;:&quot;/avatars/862fe38fe5f696d67b97a5a5ed057024.svg&quot;,&quot;isAuth&quot;:true,&quot;isWide&quot;:false,&quot;user&quot;:&quot;Chia-Min-Chang&quot;,&quot;unreadNotifications&quot;:0,&quot;csrf&quot;:&quot;eyJkYXRhIjp7ImV4cGlyYXRpb24iOjE2ODEyNzI2MjU3MjYsInVzZXJJZCI6IjY0MzRjMzYzNGIzNDM2OGZkYjA3OWU3ZSJ9LCJzaWduYXR1cmUiOiIzNGRhMjUzZTU2NzI1NDU1YzViZWUxMzA1NzQxYTQ5MmU1NTY0ZWFhZjRkMTYwOTU4YTlmYTM4ZWZkYjBlNTc1In0=&quot;}" data-target="MainHeader"><header class="border-b border-gray-100"><div class="w-full px-4 container flex h-16 items-center"><div class="flex flex-1 items-center"><a class="mr-5 flex flex-none items-center lg:mr-6" href="/"><img alt="Hugging Face's logo" class="w-7 md:mr-2" src="/front/assets/huggingface_logo-noborder.svg">
	...
	<button class="px-2 py-0.5 hover:text-gray-500 dark:hover:text-gray-600 flex items-center " type="button">
		...
		<form action="/logout" method="POST"><input type="hidden" name="csrf" value="eyJkYXRhIjp7ImV4cGlyYXRpb24iOjE2ODEyNzI2MjU3MjYsInVzZXJJZCI6IjY0MzRjMzYzNGIzNDM2OGZkYjA3OWU3ZSJ9LCJzaWduYXR1cmUiOiIzNGRhMjUzZTU2NzI1NDU1YzViZWUxMzA1NzQxYTQ5MmU1NTY0ZWFhZjRkMTYwOTU4YTlmYTM4ZWZkYjBlNTc1In0="></form>
	...
	<button class="ml-auto rounded-full ring-2 group ring-indigo-400 focus:ring-blue-500 hover:ring-offset-1 focus:ring-offset-1 focus:outline-none outline-none dark:ring-offset-gray-950 " type="button">
						...
						<div class="relative"><img alt="" class="h-[1.38rem] w-[1.38rem] overflow-hidden rounded-full" src="/avatars/862fe38fe5f696d67b97a5a5ed057024.svg">
							</div>
...
<div class="bg-gradient-to-b py-3 text-sm md:text-base from-yellow-50 to-yellow-100 text-gray-600 dark:from-yellow-500 dark:to-yellow-600 dark:text-gray-950"><div class="container "><form class="flex flex-col justify-between md:flex-row md:items-center" action="/organizations/suggestions/dismiss" method="POST"><input type="hidden" name="csrf" value="eyJkYXRhIjp7ImV4cGlyYXRpb24iOjE2ODEyNzI2MjU3MjYsInVzZXJJZCI6IjY0MzRjMzYzNGIzNDM2OGZkYjA3OWU3ZSJ9LCJzaWduYXR1cmUiOiIzNGRhMjUzZTU2NzI1NDU1YzViZWUxMzA1NzQxYTQ5MmU1NTY0ZWFhZjRkMTYwOTU4YTlmYTM4ZWZkYjBlNTc1In0=">
	...
	Copied</div></button></div></div>
			<div class="SVELTE_HYDRATER contents" data-props="{&quot;isLoggedIn&quot;:true,&quot;classNames&quot;:&quot;mr-2&quot;,&quot;isLikedByUser&quot;:false,&quot;likes&quot;:0,&quot;repoId&quot;:&quot;Chia-Min-Chang/SQL&quot;,&quot;repoType&quot;:&quot;space&quot;}" data-target="LikeButton"><div class="inline-flex items-center overflow-hidden whitespace-nowrap rounded-md border bg-white text-sm leading-none text-gray-500  mr-2"><button class="relative flex items-center px-1.5 py-1 hover:bg-gradient-to-t focus:outline-none overflow-hidden from-red-50 to-transparent dark:from-red-900 dark:to-red-800"  title="Like"><svg class="mr-1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32" fill="currentColor"><path d="M22.45,6a5.47,5.47,0,0,1,3.91,1.64,5.7,5.7,0,0,1,0,8L16,26.13,5.64,15.64a5.7,5.7,0,0,1,0-8,5.48,5.48,0,0,1,7.82,0L16,10.24l2.53-2.58A5.44,5.44,0,0,1,22.45,6m0-2a7.47,7.47,0,0,0-5.34,2.24L16,7.36,14.89,6.24a7.49,7.49,0,0,0-10.68,0,7.72,7.72,0,0,0,0,10.82L16,29,27.79,17.06a7.72,7.72,0,0,0,0-10.82A7.49,7.49,0,0,0,22.45,4Z"></path></svg>
	...
	<button class="flex items-center border-l px-1.5 py-1 text-gray-400 hover:bg-gray-50 focus:bg-gray-100 focus:outline-none dark:hover:bg-gray-900 dark:focus:bg-gray-800 " title="See users who liked this repository">0</button></div>
			...
			<div class="SVELTE_HYDRATER contents" data-props="{&quot;initRuntime&quot;:{&quot;stage&quot;:&quot;RUNNING&quot;,&quot;sdk&quot;:&quot;streamlit&quot;,&quot;sdkVersion&quot;:&quot;1.17.0&quot;,&quot;hardware&quot;:{&quot;current&quot;:&quot;cpu-basic&quot;,&quot;requested&quot;:&quot;cpu-basic&quot;,&quot;currentPrettyName&quot;:&quot;CPU Basic&quot;,&quot;requestedPrettyName&quot;:&quot;CPU Basic&quot;},&quot;resources&quot;:{&quot;requests&quot;:{&quot;cpu&quot;:&quot;65m&quot;,&quot;memory&quot;:&quot;500Mi&quot;,&quot;gpu&quot;:&quot;0&quot;,&quot;gpu_model&quot;:null,&quot;ephemeral&quot;:&quot;0G&quot;},&quot;limits&quot;:{&quot;cpu&quot;:&quot;2&quot;,&quot;memory&quot;:&quot;16Gi&quot;,&quot;gpu&quot;:&quot;0&quot;,&quot;gpu_model&quot;:null,&quot;ephemeral&quot;:&quot;50G&quot;},&quot;is_custom&quot;:false,&quot;replicas&quot;:1},&quot;gcTimeout&quot;:null},&quot;spaceId&quot;:&quot;Chia-Min-Chang/SQL&quot;,&quot;query&quot;:{},&quot;isAppTab&quot;:false,&quot;canReadLogs&quot;:true,&quot;sseApiUrl&quot;:&quot;https://sse.hf.space/Chia-Min-Chang/SQL/stage&quot;,&quot;sseApiJwt&quot;:&quot;eyJhbGciOiJFZERTQSJ9.eyJzdWIiOiJDaGlhLU1pbi1DaGFuZy9TUUwiLCJleHAiOjE2ODEyNzI2MjUsImlzcyI6Imh1Z2dpbmdmYWNlLW1vb24ifQ.PU3Yh0SOxdO38-Uv_M6KEEY1HWYP-OJFG7kuDSf_brAATWF3_YX9VgE_I3HzlxLA45SejyrAAq3iBSHYi2zFAA&quot;}" data-target="SpaceStatus">





<div class="inline-flex select-none items-center overflow-hidden font-mono text-xs mr-2 rounded-lg border px-2 py-[0.32rem] leading-none dark:bg-gray-900
					bg-green-50 
					border-green-100 
	...
	<button class="inline-flex items-center overflow-hidden whitespace-nowrap rounded-md border bg-white px-1.5 py-1 text-sm leading-none text-gray-500 hover:bg-gray-50 focus:bg-gray-100 focus:outline-none dark:hover:bg-gray-900 dark:focus:bg-gray-800"><svg class="xl:mr-1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32"><path fill="currentColor" d="M4 6h18v2H4zm0 6h18v2H4zm0 6h12v2H4zm17 0l7 5l-7 5V18z"></path></svg><span class="hidden md:block">Logs</span></button></div></h1>
		...
		<div class="flex flex-col-reverse lg:flex-row lg:items-center lg:justify-between gap-x-2 xl:ml-auto"><div class="-mb-px flex h-12 items-center overflow-x-auto overflow-y-hidden sm:h-[3.25rem]"><a class="tab-alternate " href="/spaces/Chia-Min-Chang/SQL"><svg class="mr-1.5 text-gray-400 flex-none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path class="uim-quaternary" d="M20.23 7.24L12 12L3.77 7.24a1.98 1.98 0 0 1 .7-.71L11 2.76c.62-.35 1.38-.35 2 0l6.53 3.77c.29.173.531.418.7.71z" opacity=".25" fill="currentColor"></path><path class="uim-tertiary" d="M12 12v9.5a2.09 2.09 0 0 1-.91-.21L4.5 17.48a2.003 2.003 0 0 1-1-1.73v-7.5a2.06 2.06 0 0 1 .27-1.01L12 12z" opacity=".5" fill="currentColor"></path><path class="uim-primary" d="M20.5 8.25v7.5a2.003 2.003 0 0 1-1 1.73l-6.62 3.82c-.275.13-.576.198-.88.2V12l8.23-4.76c.175.308.268.656.27 1.01z" fill="currentColor"></path></svg>
			...
			<div class="SVELTE_HYDRATER contents" data-props="{&quot;isHf&quot;:false,&quot;csrf&quot;:&quot;eyJkYXRhIjp7ImV4cGlyYXRpb24iOjE2ODEyNzI2MjU3MjYsInVzZXJJZCI6IjY0MzRjMzYzNGIzNDM2OGZkYjA3OWU3ZSJ9LCJzaWduYXR1cmUiOiIzNGRhMjUzZTU2NzI1NDU1YzViZWUxMzA1NzQxYTQ5MmU1NTY0ZWFhZjRkMTYwOTU4YTlmYTM4ZWZkYjBlNTc1In0=&quot;,&quot;space&quot;:{&quot;author&quot;:&quot;Chia-Min-Chang&quot;,&quot;colorFrom&quot;:&quot;red&quot;,&quot;colorTo&quot;:&quot;red&quot;,&quot;cardData&quot;:{&quot;title&quot;:&quot;SQL&quot;,&quot;emoji&quot;:&quot;😻&quot;,&quot;colorFrom&quot;:&quot;red&quot;,&quot;colorTo&quot;:&quot;red&quot;,&quot;sdk&quot;:&quot;streamlit&quot;,&quot;sdk_version&quot;:&quot;1.17.0&quot;,&quot;app_file&quot;:&quot;app.py&quot;,&quot;pinned&quot;:false},&quot;emoji&quot;:&quot;😻&quot;,&quot;discussionsDisabled&quot;:false,&quot;duplicationDisabled&quot;:false,&quot;id&quot;:&quot;Chia-Min-Chang/SQL&quot;,&quot;isLikedByUser&quot;:false,&quot;lastModified&quot;:&quot;2023-04-11T04:07:45.000Z&quot;,&quot;likes&quot;:0,&quot;pinned&quot;:false,&quot;private&quot;:false,&quot;gated&quot;:false,&quot;repoType&quot;:&quot;space&quot;,&quot;subdomain&quot;:&quot;chia-min-chang-sql&quot;,&quot;sdk&quot;:&quot;streamlit&quot;,&quot;staticOrigin&quot;:&quot;app.py&quot;,&quot;title&quot;:&quot;SQL&quot;,&quot;runtime&quot;:{&quot;stage&quot;:&quot;RUNNING&quot;,&quot;sdk&quot;:&quot;streamlit&quot;,&quot;sdkVersion&quot;:&quot;1.17.0&quot;,&quot;hardware&quot;:{&quot;current&quot;:&quot;cpu-basic&quot;,&quot;requested&quot;:&quot;cpu-basic&quot;,&quot;currentPrettyName&quot;:&quot;CPU Basic&quot;,&quot;requestedPrettyName&quot;:&quot;CPU Basic&quot;},&quot;resources&quot;:{&quot;requests&quot;:{&quot;cpu&quot;:&quot;65m&quot;,&quot;memory&quot;:&quot;500Mi&quot;,&quot;gpu&quot;:&quot;0&quot;,&quot;gpu_model&quot;:null,&quot;ephemeral&quot;:&quot;0G&quot;},&quot;limits&quot;:{&quot;cpu&quot;:&quot;2&quot;,&quot;memory&quot;:&quot;16Gi&quot;,&quot;gpu&quot;:&quot;0&quot;,&quot;gpu_model&quot;:null,&quot;ephemeral&quot;:&quot;50G&quot;},&quot;is_custom&quot;:false,&quot;replicas&quot;:1},&quot;gcTimeout&quot;:null},&quot;iframe&quot;:{&quot;host&quot;:&quot;https://chia-min-chang-sql.hf.space&quot;,&quot;src&quot;:&quot;https://chia-min-chang-sql.hf.space&quot;},&quot;secrets&quot;:[],&quot;sse&quot;:{&quot;stageUrl&quot;:&quot;https://sse.hf.space/Chia-Min-Chang/SQL/stage&quot;,&quot;jwt&quot;:&quot;eyJhbGciOiJFZERTQSJ9.eyJzdWIiOiJDaGlhLU1pbi1DaGFuZy9TUUwiLCJleHAiOjE2ODEyNzI2MjUsImlzcyI6Imh1Z2dpbmdmYWNlLW1vb24ifQ.PU3Yh0SOxdO38-Uv_M6KEEY1HWYP-OJFG7kuDSf_brAATWF3_YX9VgE_I3HzlxLA45SejyrAAq3iBSHYi2zFAA&quot;}},&quot;orgs&quot;:[],&quot;user&quot;:&quot;Chia-Min-Chang&quot;,&quot;linkedModels&quot;:[],&quot;linkedDatasets&quot;:[],&quot;canDisable&quot;:false}" data-target="SpaceHeaderActions">


<div class="relative my-0 flex flex-wrap gap-1.5 sm:flex-nowrap"><div class="order-last sm:order-first last:hidden last:lg:block"><div class="relative ">
	<button class="btn px-1 py-1 " type="button">
...
<div class="container relative flex flex-col md:grid md:space-y-0 w-full md:grid-cols-12  space-y-4 md:gap-6 mb-16"><section class="pt-8 border-gray-100 col-span-full"><header class="flex flex-wrap items-center justify-start pb-2 md:justify-end lg:flex-nowrap"><div class="mr-4 flex min-w-0 basis-auto flex-wrap items-center md:flex-grow md:basis-full lg:basis-auto lg:flex-nowrap"><div class="SVELTE_HYDRATER contents" data-props="{&quot;path&quot;:&quot;app.py&quot;,&quot;repoName&quot;:&quot;Chia-Min-Chang/SQL&quot;,&quot;repoType&quot;:&quot;space&quot;,&quot;rev&quot;:&quot;main&quot;,&quot;refs&quot;:{&quot;branches&quot;:[{&quot;name&quot;:&quot;main&quot;,&quot;ref&quot;:&quot;refs/heads/main&quot;,&quot;targetCommit&quot;:&quot;52e9e6e2a2c2a8ab6197d52d22356a756c1c332d&quot;}],&quot;tags&quot;:[],&quot;converts&quot;:[]},&quot;view&quot;:&quot;blob&quot;}" data-target="BranchSelector"><div class="relative mr-4 mb-2">
	<button class="text-sm md:text-base cursor-pointer w-full btn text-sm" type="button">
		...
		<div class="mb-2 flex items-center overflow-hidden"><a class="truncate text-gray-800 hover:underline" href="/spaces/Chia-Min-Chang/SQL/tree/main">SQL</a>
			<span class="mx-1 text-gray-300">/</span>
				<span class="dark:text-gray-300">app.py</span></div></div>

	
	</header>
			<div class="SVELTE_HYDRATER contents" data-props="{&quot;commitLast&quot;:{&quot;date&quot;:&quot;2023-04-11T04:05:34.000Z&quot;,&quot;subject&quot;:&quot;Create app.py&quot;,&quot;authors&quot;:[{&quot;_id&quot;:&quot;6434c3634b34368fdb079e7e&quot;,&quot;avatar&quot;:&quot;/avatars/862fe38fe5f696d67b97a5a5ed057024.svg&quot;,&quot;isHf&quot;:false,&quot;user&quot;:&quot;Chia-Min-Chang&quot;}],&quot;commit&quot;:{&quot;id&quot;:&quot;961845b8dec51113f6f06cfe5af8054f072eb400&quot;,&quot;parentIds&quot;:[&quot;dec4511314099e3853f5c694e34253c30ce42bbd&quot;]},&quot;title&quot;:&quot;Create app.py&quot;},&quot;repo&quot;:{&quot;name&quot;:&quot;Chia-Min-Chang/SQL&quot;,&quot;type&quot;:&quot;space&quot;}}" data-target="LastCommit"><div class="from-gray-100-to-white flex items-baseline rounded-t-lg border border-b-0 bg-gradient-to-t px-3 py-2 dark:border-gray-800"><img class="mt-0.5 mr-2.5 h-4 w-4 self-center rounded-full" alt="Chia-Min-Chang's picture" src="/avatars/862fe38fe5f696d67b97a5a5ed057024.svg">
			<div class="mr-5 flex flex-none items-center truncate"><a class="hover:underline" href="/Chia-Min-Chang">Chia-Min-Chang
					</a>
				
			</div>
		<div class="mr-4 truncate font-mono text-sm text-gray-500 hover:prose-a:underline"><!-- HTML_TAG_START -->Create app.py<!-- HTML_TAG_END --></div>
		<a class="rounded border bg-gray-50 px-1.5 text-sm hover:underline dark:border-gray-800 dark:bg-gray-900" href="/spaces/Chia-Min-Chang/SQL/commit/961845b8dec51113f6f06cfe5af8054f072eb400">961845b</a>
		
		<time class="ml-auto hidden flex-none truncate pl-2 text-gray-500 dark:text-gray-400 lg:block" datetime="2023-04-11T04:05:34" title="Tue, 11 Apr 2023 04:05:34 GMT">5 minutes ago</time></div></div>
			<div class="flex flex-wrap items-center border px-3 py-1.5 text-sm text-gray-800 dark:border-gray-800 dark:bg-gray-900">
				<a class="my-1 mr-4 flex items-center hover:underline " href="/spaces/Chia-Min-Chang/SQL/raw/main/app.py"><svg class="mr-1.5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32" style="transform: rotate(360deg);"><path d="M31 16l-7 7l-1.41-1.41L28.17 16l-5.58-5.59L24 9l7 7z" fill="currentColor"></path><path d="M1 16l7-7l1.41 1.41L3.83 16l5.58 5.59L8 23l-7-7z" fill="currentColor"></path><path d="M12.419 25.484L17.639 6l1.932.518L14.35 26z" fill="currentColor"></path></svg>
							raw
						</a><a class="my-1 mr-4 flex items-center hover:underline " href="/spaces/Chia-Min-Chang/SQL/commits/main/app.py"><svg class="mr-1.5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32" style="transform: rotate(360deg);"><path d="M16 4C9.383 4 4 9.383 4 16s5.383 12 12 12s12-5.383 12-12S22.617 4 16 4zm0 2c5.535 0 10 4.465 10 10s-4.465 10-10 10S6 21.535 6 16S10.465 6 16 6zm-1 2v9h7v-2h-5V8z" fill="currentColor"></path></svg>
							history
						</a><a class="my-1 mr-4 flex items-center hover:underline " href="/spaces/Chia-Min-Chang/SQL/blame/main/app.py"><svg class="mr-1.5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32" style="transform: rotate(360deg);"><path d="M16 2a14 14 0 1 0 14 14A14 14 0 0 0 16 2zm0 26a12 12 0 1 1 12-12a12 12 0 0 1-12 12z" fill="currentColor"></path><path d="M11.5 11a2.5 2.5 0 1 0 2.5 2.5a2.48 2.48 0 0 0-2.5-2.5z" fill="currentColor"></path><path d="M20.5 11a2.5 2.5 0 1 0 2.5 2.5a2.48 2.48 0 0 0-2.5-2.5z" fill="currentColor"></path></svg>
							blame
				...
				<div class="dark:text-gray-300 sm:ml-auto">910 Bytes</div></div>

			<div class="relative min-h-[100px] rounded-b-lg border border-t-0 leading-tight dark:border-gray-800 dark:bg-gray-925">
				<div class="py-3"><div class="SVELTE_HYDRATER contents" data-props="{&quot;lines&quot;:[&quot;<span class=\&quot;hljs-keyword\&quot;>import</span> pandas <span class=\&quot;hljs-keyword\&quot;>as</span> pd&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>import</span> streamlit <span class=\&quot;hljs-keyword\&quot;>as</span> st&quot;,&quot;&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>import</span> altair <span class=\&quot;hljs-keyword\&quot;>as</span> alt&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>import</span> duckdb&quot;,&quot;&quot;,&quot;con = duckdb.connect(database=<span class=\&quot;hljs-string\&quot;>&amp;#x27;Job.db&amp;#x27;</span>, read_only=<span class=\&quot;hljs-literal\&quot;>True</span>) &quot;,&quot;&quot;,&quot;<span class=\&quot;hljs-comment\&quot;># Countries</span>&quot;,&quot;query=<span class=\&quot;hljs-string\&quot;>&amp;quot;&amp;quot;&amp;quot;</span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>   SELECT * </span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>   FROM job</span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>&amp;quot;&amp;quot;&amp;quot;</span>&quot;,&quot;Countries=<span class=\&quot;hljs-built_in\&quot;>list</span>(con.execute(query).df().columns)[<span class=\&quot;hljs-number\&quot;>2</span>:]&quot;,&quot;&quot;,&quot;&quot;,&quot;st.subheader(<span class=\&quot;hljs-string\&quot;>&amp;#x27;Investingation&amp;#x27;</span>)&quot;,&quot;&quot;,&quot;col1, col2 = st.columns(<span class=\&quot;hljs-number\&quot;>2</span>)&quot;,&quot;&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>with</span> col1:&quot;,&quot;    query=<span class=\&quot;hljs-string\&quot;>&amp;quot;&amp;quot;&amp;quot;</span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>            SELECT </span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>                 DISTINCT variable</span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>            From job        </span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>            ORDER BY variable       </span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>          &amp;quot;&amp;quot;&amp;quot;</span>&quot;,&quot;&quot;,&quot;    kinds=con.execute(query).df()&quot;,&quot;    kind = st.selectbox(<span class=\&quot;hljs-string\&quot;>&amp;#x27;Kind of Statistics&amp;#x27;</span>,kinds)&quot;,&quot;<span class=\&quot;hljs-keyword\&quot;>with</span> col2: &quot;,&quot;    country = st.selectbox(<span class=\&quot;hljs-string\&quot;>&amp;#x27;Country&amp;#x27;</span>,Countries)&quot;,&quot;&quot;,&quot;&quot;,&quot;result_df = con.execute(<span class=\&quot;hljs-string\&quot;>&amp;quot;&amp;quot;&amp;quot;</span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>    SELECT </span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>        *</span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>    FROM Job </span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>    WHERE variable=?</span>&quot;,&quot;<span class=\&quot;hljs-string\&quot;>    &amp;quot;&amp;quot;&amp;quot;</span>, [kind]).df()&quot;,&quot;&quot;,&quot;chart = alt.Chart(result_df).mark_circle().encode(&quot;,&quot;    x = <span class=\&quot;hljs-string\&quot;>&amp;#x27;date&amp;#x27;</span>,&quot;,&quot;    y = country,&quot;,&quot;    <span class=\&quot;hljs-comment\&quot;>#color = &amp;#x27;carrier&amp;#x27;</span>&quot;,&quot;).interactive()&quot;,&quot;st.altair_chart(chart, theme=<span class=\&quot;hljs-string\&quot;>&amp;quot;streamlit&amp;quot;</span>, use_container_width=<span class=\&quot;hljs-literal\&quot;>True</span>)&quot;],&quot;context&quot;:{&quot;repo&quot;:{&quot;name&quot;:&quot;Chia-Min-Chang/SQL&quot;,&quot;type&quot;:&quot;space&quot;},&quot;revision&quot;:&quot;52e9e6e2a2c2a8ab6197d52d22356a756c1c332d&quot;,&quot;path&quot;:&quot;app.py&quot;}}" data-target="BlobContent">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-keyword">import</span> altair <span class="hljs-keyword">as</span> alt<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L5">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-keyword">import</span> duckdb<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L6">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->con = duckdb.connect(database=<span class="hljs-string">&#x27;Job.db&#x27;</span>, read_only=<span class="hljs-literal">True</span>) <!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L8">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-comment"># Countries</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L10">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->query=<span class="hljs-string">&quot;&quot;&quot;</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L11">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-string">   SELECT * </span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L12">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-string">   FROM job</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L13">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->Countries=<span class="hljs-built_in">list</span>(con.execute(query).df().columns)[<span class="hljs-number">2</span>:]<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L15">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->st.subheader(<span class="hljs-string">&#x27;Investingation&#x27;</span>)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L18">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->col1, col2 = st.columns(<span class="hljs-number">2</span>)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L20">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-keyword">with</span> col1:<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L22">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-string">                 DISTINCT variable</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L25">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-string">            ORDER BY variable       </span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L27">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->    kinds=con.execute(query).df()<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L30">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->    kind = st.selectbox(<span class="hljs-string">&#x27;Kind of Statistics&#x27;</span>,kinds)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L31">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-keyword">with</span> col2: <!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L32">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->    country = st.selectbox(<span class="hljs-string">&#x27;Country&#x27;</span>,Countries)<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L33">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->result_df = con.execute(<span class="hljs-string">&quot;&quot;&quot;</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L36">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-string">    WHERE variable=?</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L40">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START --><span class="hljs-string">    &quot;&quot;&quot;</span>, [kind]).df()<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L41">
...
<!-- HTML_TAG_END --></td>
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->chart = alt.Chart(result_df).mark_circle().encode(<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L43">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->    x = <span class="hljs-string">&#x27;date&#x27;</span>,<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L44">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->    y = country,<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L45">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->    <span class="hljs-comment">#color = &#x27;carrier&#x27;</span><!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L46">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->).interactive()<!-- HTML_TAG_END --></td>
					</tr><tr class="" id="L47">
						...
						<td class="overflow-visible whitespace-pre px-3"><!-- HTML_TAG_START -->st.altair_chart(chart, theme=<span class="hljs-string">&quot;streamlit&quot;</span>, use_container_width=<span class="hljs-literal">True</span>)<!-- HTML_TAG_END --></td>
					</tr></tbody></table></div>
	</div></div></div></div></section></div></main>
	</div>

		<script>
			import("/front/build/index.5b4f05534.js");
			window.moonSha = ".5b4f05534";
			window.hubConfig = JSON.parse(`{"blogAndDoc":true,"isPrivateHub":false,"privateHubName":"private","signupDisabled":false,"sshGitUrl":"git@hf.co","moonHttpUrl":"https://huggingface.co","captchaApiKey":"bd5f2066-93dc-4bdd-a64b-a24646ca3859","features":{"autotrain":true,"datasetsServer":true,"inferenceApi":true,"repositoryScanner":true,"spaces":true,"tensorboards":true},"exposeDockerImages":true}`);
		</script>
